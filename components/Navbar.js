...
export default function Navbar() {
    return (
        ...
        <nav className="flex  justify-between md:mt-1 md:px-10 px-5 md:py-5 py-3 bg-[#100f10] md:rounded-xl text-white  shadow-md">
            <div className={audiowide.className}>
                <p className="uppercase tracking-widest md:text-2xl text-xs font-bold">recipe</p>
            </div>
            <div className={audiowide.className}>
